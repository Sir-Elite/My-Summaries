...
3. Access the script in the `HTML` code using `<script src="script.js">`
#####
    <body>
...
The most important primitive data types are the first three. `JavaScript` has dynamic typing (we donot manually define the type of a variable, it is done automatically by the language).
#### I. Numbers
